...
export default function PestanaCatalogo({ miId, nombreLocal }: any) {
  ...
  return (
    <>
      {/* VISTA PARA IMPRESIÓN (PDF NORMAL) */}
        ...
        {modalQR && (
          <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center p-4">
            <div className="bg-white w-full max-w-sm p-8 rounded-3xl slide-up text-center shadow-2xl relative">
              ...
              <button 
                onClick={descargarQR}
                className="w-full bg-stone-800 text-white p-4 rounded-2xl font-bold shadow-md flex justify-center items-center gap-3 hover:bg-stone-900 transition-transform active:scale-95"
              >
